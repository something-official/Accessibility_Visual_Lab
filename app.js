...
function savePng() { const link = document.createElement('a'); link.download = 'accessibility_visual_lab-canvas.png'; link.href = canvas.toDataURL('image/png'); link.click(); status.textContent = 'PNG prepared locally.'; }
