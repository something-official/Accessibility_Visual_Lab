# Accessibility Visual Lab

Accessibility Visual Lab turns common interface rules into an inspectable visual scene. Camera input is optional and only changes the emphasis signal; the core lesson works with keyboard and pointer controls.

## What this demonstrates

- Visualizing contrast relationships
- Making focus and hit areas obvious
- Respecting prefers-reduced-motion
- Avoiding color-only state communication
- Testing a camera optional path safely
